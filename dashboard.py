...
# Optional: Load dataset for future use (commented out to speed up)
# url = "https://raw.githubusercontent.com/shrutimishra08/redbull-dashboard1/refs/heads/main/employee_data.csv"
